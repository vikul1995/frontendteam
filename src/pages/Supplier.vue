            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0"><a href="#">Suppliers</a></h2>
                            
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                     <li class="breadcrumb-item active"><a href="timeline">Timeline</a>
                                    <li class="breadcrumb-item active"><a href="#">Suppliers</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-detached content-right">
                <div class="content-body">
                  ...
                  <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card" v-for="Supplier in Suppliers" :key="Supplier.id">
                            <router-link :to="{ name: 'details',params:{id:Supplier.id,category_name:'Suppliers'}}"><div class="card-content">
                                <div class="item-img text-center">
                                    
                                        <img class="img-fluid"  :src="Supplier.Images[0].image" alt="img-placeholder">
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details.html">{{Supplier.name}}</a>
                                        <p class="item-company">By <span class="company-name">{{Supplier.company}}</span></p>
                                    </div>
                                    <div>
                                ...
                                <div class="item-options text-center">
                                   ...
                                   <div  v-for="subcategory in subcategories"  :key="subcategory.id">
                                      <div  v-if="subcategory.id==Supplier.subcategory_id">
                                       <a style="float:left;margin-top:10px ; margin-left:10px ;font-size:12px;color:white" href=""> Suppliers / {{subcategory.subcategory_name}}</a>
                                    </div>
...
import EquipmentDataService from "../services/EquipmentDataService";
  ...
  created() {
        ...
        ServicesDataService.getsubcategory(3)
        .then(response => {
        ...
        .then(response => {
          ...
          this.count=(this.Suppliers).length;
  ...
  class GeoData{
            ...
            for(let i =0;i<(this.Suppliers).length;i++)
             ...
             let coordinates = [parseFloat(this.Suppliers[i].longitude),parseFloat(this.Suppliers[i].latitude)];
               let companyName = this.Suppliers[i].company;
   ...
   methods: {
     fetchSuppliersData: async function(ids){
        document.getElementById("Supplier").style.opacity = 0.5;

if(ids.length==0){
    let responseData = await SupplierDataService.getAll()
          this.Suppliers = responseData.data.data.data;
        document.getElementById("Supplier").style.opacity = 1;
    ...
    return;
        ...
        for(let i=0;i<ids.length;i++){
            ...
            let response = await SupplierDataService.getSuppliersubcategoryid(ids[i]);
           {
    ...
    searchdata: async function(event){
        ...
        document.getElementById("Supplier").style.opacity = 0.5;
           event.preventDefault();
            ...
            this.coordinates=[];
               ...
               let response = await SupplierDataService.Suppliersearch(formData);
        ...
        companydesc:function(){
            this.Suppliers=[];
           SupplierDataService.getcompanydesc()
        .then(response => {
          this.Suppliers = response.data.data;
          console.log(response.data);
        ...
        companyasc:function(){
            this.Suppliers=[];
           SupplierDataService.getcompanyasc()
        .then(response => {
          this.Suppliers = response.data.data;
          console.log(response.data);
        ...
        subcategoryasc:function(){
             this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategoryasc(3)
        .then(response => {
        ...
        subcategorydesc:function(){
             this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategorydesc(3)
        .then(response => {
          this.subcategories = response.data.data;
          console.log(response.data);
        ...
        subcategorysearch:function(event){
           ...
           event.preventDefault();
                ...
                EquipmentDataService.subcategorysearch(formData,3)
                    .then(response=>{
