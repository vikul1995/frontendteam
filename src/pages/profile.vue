                            ...
                            <div class="profile-header mb-2">
                                ...
                                <div class="relative">
                                    <div class="cover-container">
                                      <div class="item-img text-center" style="width:150px;height:120px;margin-top:5px">

                                     <figure><span  style=" margin-right: 20px;  margin-left: 20px;" ><img :src="image.profileimg"  style="width: 150px;height:120px;" /></span></figure>
                                       </div>
                                     <input type="file"  accept="image/*" name="image" id="file"   style="display: none;">
                                        <p><label for="file" @click="loadFile()" style="cursor: pointer;">Upload Image</label></p>
