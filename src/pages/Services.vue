            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0"><a href="#">Services</a></h2>
                            
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                     <li class="breadcrumb-item active"><a href="timeline">Timeline</a>
                                    <li class="breadcrumb-item active"><a href="#">Services</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-detached content-right">
                <div class="content-body">
                  ...
                  <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card" v-for="Service in Services" :key="Service.id">
                            <router-link :to="{ name: 'details',params:{id:Service.id,category_name:'Equipments'}}"><div class="card-content">
                                <div class="item-img text-center">
                                    
                                        <img class="img-fluid"  :src="Service.Images[0].image" alt="img-placeholder">
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details.html">{{Service.name}}</a>
                                        <p class="item-company">By <span class="company-name">{{Service.company}}</span></p>
                                    </div>
                                    <div>
                                ...
                                <div class="item-options text-center">
                                   ...
                                   <div  v-for="subcategory in subcategories"  :key="subcategory.id">
                                      <div  v-if="subcategory.id==Service.subcategory_id">
                                       <a style="float:left;margin-top:10px ; margin-left:10px ;font-size:12px;color:white" href=""> Services / {{subcategory.subcategory_name}}</a>
                                    </div>
...
import EquipmentDataService from "../services/EquipmentDataService";
  ...
  created() {
        ...
        ServicesDataService.getsubcategory(1)
        .then(response => {
  ...
  class GeoData{
            ...
            for(let i =0;i<(this.Services).length;i++)
             ...
             let coordinates = [parseFloat(this.Services[i].longitude),parseFloat(this.Services[i].latitude)];
               let companyName = this.Services[i].company;
   ...
   methods: {
     fetchServicesData: async function(ids){
        document.getElementById("Service").style.opacity = 0.5;

if(ids.length==0){
    let responseData = await ServicesDataService.getAll()
          this.Services = responseData.data.data.data;
    ...
    return;
        ...
        for(let i=0;i<ids.length;i++){
            ...
            let response = await ServicesDataService.getServicesubcategoryid(ids[i]);
           {
    ...
    searchdata: async function(event){
        ...
        document.getElementById("Service").style.opacity = 0.5;
           event.preventDefault();
            ...
            this.coordinates=[];
               ...
               let response = await ServicesDataService.Servicesearch(formData);
        ...
        companydesc:function(){
            this.Services=[];
           ServicesDataService.getcompanydesc()
        .then(response => {
          this.Services = response.data.data;
          console.log(response.data);
        ...
        companyasc:function(){
            this.Services=[];
           ServicesDataService.getcompanyasc()
        .then(response => {
          this.Services = response.data.data;
          console.log(response.data);
        ...
        subcategoryasc:function(){
            this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategoryasc(1)
        .then(response => {
        ...
        subcategorydesc:function(){
            this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategorydesc(1)
        .then(response => {
          this.subcategories = response.data.data;
          console.log(response.data);
        ...
        subcategorysearch:function(event){
           ...
           event.preventDefault();
                ...
                EquipmentDataService.subcategorysearch(formData,1)
                    .then(response=>{
