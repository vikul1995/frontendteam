            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0"><a href="#">Unit_rigs</a></h2>
                            
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                     <li class="breadcrumb-item active"><a href="timeline">Timeline</a>
                                    <li class="breadcrumb-item active"><a href="#">Unit_rigs</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-detached content-right">
                <div class="content-body">
                  ...
                  <section id="ecommerce-products" class="grid-view">
                        <div class="card ecommerce-card" v-for="Unit_rig in Unit_rigs" :key="Unit_rig.id">
                            <router-link :to="{ name: 'details',params:{id:Unit_rig.id,category_name:'Unit_rigs'}}"><div class="card-content">
                                <div class="item-img text-center">
                                    
                                        <img class="img-fluid"  :src="Unit_rig.Images[0].image" alt="img-placeholder">
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="item-name">
                                        <a href="app-ecommerce-details.html">{{Unit_rig.name}}</a>
                                        <p class="item-company">By <span class="company-name">{{Unit_rig.company}}</span></p>
                                    </div>
                                    <div>
                                        <p class="item-description"
                                           v-html="Unit_rig.description">
                                        </p>
                                    </div>
                                </div>
                                <div class="item-options text-center">
                                   ...
                                   <div  v-for="subcategory in subcategories"  :key="subcategory.id">
                                      <div  v-if="subcategory.id==Unit_rig.subcategory_id">
                                       <a style="float:left;margin-top:10px ; margin-left:10px ;font-size:12px;color:white" href=""> Unit_rigs / {{subcategory.subcategory_name}}</a>
                                    </div>
...
import Unit_rigDataService from "../services/Unit_rigsDataService";
    export default {
  name: "Unit_rig",
  data() {
       return {
  ...
  created() {
        ...
        ServicesDataService.getsubcategory(4)
        .then(response => {
        ...
        .catch(e => {
         ...
         Unit_rigDataService.getAll()
        .then(response => {
          this.Unit_rigs = response.data.data.data;
          this.count=(this.Unit_rigs).length;
          console.log(this.Unit_rigs);
  ...
  class GeoData{
            ...
            for(let i =0;i<(this.Unit_rigs).length;i++)
             {
                  
             let coordinates = [parseFloat(this.Unit_rigs[i].longitude),parseFloat(this.Unit_rigs[i].latitude)];
               let companyName = this.Unit_rigs[i].company;
   ...
   methods: {
     fetchUnit_rigsData: async function(ids){
        document.getElementById("Unit_rig").style.opacity = 0.5;

if(ids.length==0){
    let responseData = await Unit_rigDataService.getAll()
          this.Unit_rigs = responseData.data.data.data;
        document.getElementById("Unit_rig").style.opacity = 1;
    ...
    return;
        ...
        for(let i=0;i<ids.length;i++){
            ...
            let response = await Unit_rigDataService.getUnit_rigsubcategoryid(ids[i]);
           {
    ...
    searchdata: async function(event){
        ...
        document.getElementById("Unit_rig").style.opacity = 0.5;
           event.preventDefault();
            ...
            this.coordinates=[];
               ...
               let response = await Unit_rigDataService.Unit_rigsearch(formData);
        ...
        acending:function(){
            this.Unit_rigs=[];
           Unit_rigDataService.getasc()
        .then(response => {
          this.Unit_rigs = response.data.data;
          console.log(response.data);
        ...
        companydesc:function(){
            this.Unit_rigs=[];
           Unit_rigDataService.getcompanydesc()
        .then(response => {
          this.Unit_rigs = response.data.data;
          console.log(response.data);
        ...
        companyasc:function(){
            this.Unit_rigs=[];
           Unit_rigDataService.getcompanyasc()
        .then(response => {
          this.Unit_rigs = response.data.data;
          console.log(response.data);
        ...
        subcategoryasc:function(){
             this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategoryasc(4)
        .then(response => {
        ...
        subcategorydesc:function(){
             this.search='';
            this.subcategories=[];
           EquipmentDataService.getsubcategorydesc(4)
        .then(response => {
          this.subcategories = response.data.data;
          console.log(response.data);
        ...
        subcategorysearch:function(event){
           ...
           event.preventDefault();
                ...
                EquipmentDataService.subcategorysearch(formData,4)
                    .then(response=>{
